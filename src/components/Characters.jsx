        ...
        <div className="relative z-10 flex md:flex-row flex-col items-center w-full h-full p-4">
            ...
            <div className="w-full md:w-2/4 flex flex-col md:ml-10">
             ...
             <div className="grid grid-cols-2 gap-4">
               {/* VIKI CARD */}
               <div onClick={() => setSelectedAvatar("VIKI")} className="relative bg-gray-900/70 backdrop-blur-sm rounded-lg p-3 border flex lg:flex-row flex-col justify-between px-12 items-center cursor-pointer transition-all duration-300">
                  ...
                  <div className="flex">
                    {[...Array(currentAvatar.star)].map((_, index) => (
                      <Star key={index} className="text-violet-500 fill-violet-400 w-4 h-4" />
                    ))}
                  </div>
               ...
               {/* EVA CARD */}
               <div onClick={() => setSelectedAvatar("EVA")} className="relative bg-gray-900/70 backdrop-blur-sm rounded-lg p-3 border flex lg:flex-row flex-col justify-between px-12 items-center cursor-pointer transition-all duration-300">
